...
1. Huiszoekingen zijn op bepaalde voorwaarde toegestaan.
       ...
       - Hieronder worden de voorwaarde voor een huiszoeking beschreven.
       - Een huiszoeking mag plaats vinden als de verdachte voor het 5de maal is aangehouden met een wapen van welke aard dan ook.
...
2. Wat mag er doorzocht worden tijdens een huiszoeking?
       ...
       - Bij een huiszoeking mag de contrainer van verdachte worden gecontroleerd.
...
3. Tijdens een huiszoeking mogen de volgende dingen inbeslag worden genomen:
...
4. Regels tijdens een huiszoeking.
       ...
       - Tijdens een huiszoeking mag de verdachte niet worden vrijgebroken. (Tenzij de verdachte vanuit het hoofdbureau naar de gevangenis vervoerd wordt)
       - Als de vedachte word vrijgebroken door zijn/haar eigen gangmembers zal persoon niet 50% moeten afstaan maar 30% en krijg dus 70% van de totale inhoud terug.
